...
public class AddressBook {
     ...
     * The different data element of a person is listed in the below enum
     */
    ...
    private static ArrayList<HashMap<PersonProperty, String>> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        ...
        final Collection<String> keywordsInLowerCase = convertWordsToLowerCase(keywords);
        for (HashMap<PersonProperty, String> person : getAllPersonsInAddressBook()) {
            final Set<String> wordsInNameInLowerCase = new HashSet<>(convertWordsToLowerCase(splitByWhitespace(getNameFromPerson(person))));
    ...
    private static ArrayList<HashMap<PersonProperty, String>> sortAllPersonsInAddressBook() {
        ArrayList<HashMap<PersonProperty, String>> sortedPersonsList = new ArrayList<>(ALL_PERSONS);
        Collections.sort(sortedPersonsList, new Comparator<HashMap<PersonProperty, String>>() {
                    @Override
                    public int compare(HashMap<PersonProperty, String> p1, HashMap<PersonProperty, String> p2) {
                        return p1.get(PersonProperty.NAME).compareTo(p2.get(PersonProperty.NAME));
                    }
                });
    ...
    private static String removePrefix(String s, String prefix) {
        ...
        if (s.substring(0, prefixLength).equals(prefix)) {return s.substring(prefixLength);}
        return s;
    }
    ...
    /**
     * Convert all word in a set to lowercase
     *
     * @param words collection
     * @return words convert to lowercase
     */
    private static Collection<String> convertWordsToLowerCase(Collection<String> words) {
        Collection<String> wordsInLowercase = new HashSet<String>();
